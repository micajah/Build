...
GO 
--
-- Script To Update dbo.Author Table In Largo.et_test_db
-- Generated Saturday, December 1, 2007, at 05:06 AM
--
...
PRINT 'Updating dbo.Author Table'
GO
...
IF @@TRANCOUNT = 2
   SET IDENTITY_INSERT [dbo].[tmp_Author] ON
GO
...
IF @@TRANCOUNT = 2
   INSERT INTO [dbo].[tmp_Author] ([Author_ID], [Name])
...
IF @@TRANCOUNT = 2
   SET IDENTITY_INSERT [dbo].[tmp_Author] OFF
GO
...
sp_rename N'[dbo].[tmp_Author]', N'Author'
...
IF @@TRANCOUNT = 2
   ALTER TABLE [dbo].[Author] ADD CONSTRAINT [PK_Author] PRIMARY KEY CLUSTERED ([Author_ID])
GO
...
GO
exec('CREATE TRIGGER dbo.AUTHOR_UPDATE on dbo.Author for update as
if @@error <>0 
begin
...
IF @@TRANCOUNT = 2
BEGIN
   PRINT 'dbo.Author Table Updated Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Update dbo.Author Table'
END
GO
...
--
-- Script To Update dbo.AUTHOR_UPDATE Trigger In Largo.et_test_db
-- Generated Saturday, December 1, 2007, at 05:06 AM
--
-- Please backup Largo.et_test_db before executing this script
--
...
PRINT 'Updating dbo.AUTHOR_UPDATE Trigger'
GO
...
SET QUOTED_IDENTIFIER OFF
GO
exec('ALTER TRIGGER dbo.AUTHOR_UPDATE on dbo.Author for update as
if @@error <>0 
begin
	raiserror (''Trigger Author Error'',16,1)
end')
...
IF @@TRANCOUNT = 2
BEGIN
   PRINT 'dbo.AUTHOR_UPDATE Trigger Updated Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Update dbo.AUTHOR_UPDATE Trigger'
END
GO
